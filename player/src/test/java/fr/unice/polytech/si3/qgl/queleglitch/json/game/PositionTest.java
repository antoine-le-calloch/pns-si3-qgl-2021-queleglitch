...
class PositionTest {
    ...
    void getAngleToAPlaceIn_100_0(){
        assertEquals(0, position0_0.getAngleToAPosition(new Position(100, 0, 0)));
    }

    @Test
    void getAngleToAPlaceIn_100_100(){
        assertEquals(Math.PI/4, position0_0.getAngleToAPosition(new Position(100, 100, 0)));
    }

    @Test
    void getAngleToAPlaceIn_0_100(){
        assertEquals(Math.PI/2, position0_0.getAngleToAPosition(new Position(0, 100, 0)));
    }

    @Test
    void getAngleToAPlaceIn_Minus100_100(){
        assertEquals(3*Math.PI/4, position0_0.getAngleToAPosition(new Position(-100, 100, 0)));
    }

    @Test
    void getAngleToAPlaceIn_Minus100_0(){
        assertEquals(Math.PI, position0_0.getAngleToAPosition(new Position(-100, 0, 0)));
    }
    ...
    void getAngleToAPlaceIn_100_0_PositionIn100_0(){
        assertEquals(0, position100_0.getAngleToAPosition(new Position(200, 0, 0)));
    }

    @Test
    void getAngleToAPlaceIn_100_100_PositionIn100_0(){
        assertEquals(Math.PI/4, position100_0.getAngleToAPosition(new Position(200, 100, 0)));
    }

    @Test
    void getAngleToAPlaceIn_0_100_PositionIn100_0(){
        assertEquals(Math.PI/2, position100_0.getAngleToAPosition(new Position(100, 100, 0)));
    }

    @Test
    void getAngleToAPlaceIn_Minus100_100_PositionIn100_0(){
        assertEquals(3*Math.PI/4, position100_0.getAngleToAPosition(new Position(0, 100, 0)));
    }

    @Test
    void getAngleToAPlaceIn_Minus100_0_PositionIn100_0(){
        assertEquals(Math.PI, position100_0.getAngleToAPosition(new Position(0, 0, 0)));
    }
