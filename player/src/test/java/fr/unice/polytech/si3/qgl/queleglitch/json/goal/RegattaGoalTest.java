...
class RegattaGoalTest {
    ...
    void calculateOptiCheckpoint_100_100_To_100_Minus5(){
        ...
        assertEquals(new Position(100.00000000000001,-25,0) ,regattaGoal.positionOptiCheckpoints[0]);
        assertEquals(new Position(100,100,0) ,regattaGoal.positionOptiCheckpoints[1]);
    }
}